  ...
  const socialLinks = [
    {
      ...
      url: "https://github.com/Talhabadar184",
    ...
    },
    {
      ...
      url: "https://www.instagram.com/talha_badar_13",
    ...
    },
    {
      ...
      url: "https://www.linkedin.com/in/talha-badar-312195253/",
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="text-center md:text-left">
            <p className="text-gray-400">
              ...
              <span className="text-cyan-400 font-medium">Talha Badar</span>
            </p>
          </div>
