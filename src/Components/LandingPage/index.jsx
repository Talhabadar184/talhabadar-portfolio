...
import ParticlesBg from "./particlesbg"; // 👈 import your particles
...
const LandingPage = () => {
  ...
  transition={{
      ...
      {/* Main Content */}
      <div className="relative z-1 flex flex-col items-center justify-center flex-grow text-center space-y-6 sm:space-y-8 px-4">
        {/* Greeting */}
        <motion.div
...
// import ParticlesBg from "../LandingPage/particlesbg";
