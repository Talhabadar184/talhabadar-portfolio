...
const AboutMe = () => {
  ...
  const stats = [
    { icon: <FaCode />, number: "5+", label: "Completed Projects", color: "from-blue-400 to-cyan-500" },
  ...
  const skills = [
    "MERN-Stack Development", "AI/ML Engineering", "Cloud Computing",
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-6">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
                I'm Talha, a passionate technologist
              </h2>
              
              <div className="space-y-3 sm:space-y-4 text-gray-300 leading-relaxed">
                <p className="text-base sm:text-lg">
                  I'm a MERN Stack Developer, AI Engineer, and ML/DL enthusiast with a passion for 
                ...
                <p className="text-base sm:text-lg">
                  With expertise in React, Next, Tailwind CSS, , and Python  , 
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 pt-4">
              <a
                href="https://github.com/Talhabadar184"
                target="_blank"
